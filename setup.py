...
setup(
    ...
    install_requires=['pint==0.9', 'ht==0.1.52', 'fluids==0.1.74',
				      ...
				      'coolprop==6.3.0', 'numpy', 'xlrd==1.2.0',
                      'openpyxl==3.0.0',
                      'free_properties>=0.2.3', 'flexsolve>=0.1.2', 'pyglet', 'sympy'],
    python_requires=">=3.6",
    package_data=
    ...
    url='https://github.com/yoelcortes/thermosteam',
    download_url='https://github.com/yoelcortes/thermosteam.git',
