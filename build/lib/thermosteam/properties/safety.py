# -*- coding: utf-8 -*-
'''
All data and methods for retrieving a chemical's safety data.
'''
...
from .identifiers import CAS_from_any

folder = os.path.join(os.path.dirname(__file__), 'Data/Safety')
