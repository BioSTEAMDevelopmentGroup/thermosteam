...
class VLE:
    ...
    def set_PH(self, P, H):
        ...
        dH_dew = H - H_dew
        if dH_dew >= 0:
            self._thermal_condition.T = self._mixture.xsolve_T(self._phase_data, H, T_dew, P)
        ...
        dH_bubble = H - H_bubble
        if dH_bubble <= 0:
            self._thermal_condition.T = self._mixture.xsolve_T(self._phase_data, H, T_bubble, P)
